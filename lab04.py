...
input("Roll the dive for your first item (Press enter)")
loot_item1_idx = random.choice(list(range(1, 5)))
...
input("Roll the dive for your second item (Press enter)")
loot_item2_idx = random.choice(list(range(1, 5)))
